...
<nav id="sidebar">
      ...
      <div class="sidebar_blog_2">
         ...
         <ul class="list-unstyled components">
            ...
            <li><a href="manageemp.php"><i class="fa fa-pencil-square-o orange_color"></i> <span>View employee</span></a></li>



            <li><a href="viewreq.php"><i class="fa fa-briefcase blue1_color"></i> <span>view requests</span></a></li>
