                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php }else if ($m['status']==1){?>
                                                            ...
                                                            <td colspan="2">
                                                        <a href="../controller/updatereqstatus.php?id=<?php echo  $m['req_id'] ?>&c_status=3" class="btn btn-primary">Accepted</a>
                                                        ...
                                                        <?php }else if ($m['status']==3){ ?>
                                                            <td>
                                                        <a href="../controller/updatereqstatus.php?id=<?php echo  $m['req_id'] ?>" class="btn btn-success">Done</a>

                                                        </td>
                                                        <?php }else{ ?>
                                                            <td>
                                                        <a href="../controller/updatereqstatus.php?id=<?php echo  $m['req_id'] ?>" class="btn btn-success">Something wrong</a>
